...
def create_for_Owners():
    ...
    if st.button("Add Owners Details"):
        add_Owners_data(Owner_id,Owner_Name, Contact_NO, DOB, Gender, Address, Partnership)
...
def create_for_Invoice():
    with st.container():
        ...
        Fuel_Amount=st.number_input("Fuel_Liters:")
...
def create_for_Tanker():
    with st.container():
        ...
        Fuel_Amount = st.number_input("total_cost")
