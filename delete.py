...
def delete_for_Petrolpump():
    ...
    df = pd.DataFrame(result, columns=['Registration_No','Petrolpump_Name','Company_Name','Owner_id','Opening_Year','State','City'])
    ...
    df2 = pd.DataFrame(result2, columns=['Registration_No','Petrolpump_Name','Company_Name','Owner_id','Opening_Year','State','City'])
